<?php
	...
	*/
	...
	{	
		...
		// Discord push to staff
		require_code('global3');
		http_download_file('https://discordapp.com/api/webhooks/276127156701102083/AC3U7mWGK04oYIQ0sPITYD7QY60VAMWPMBUU_KxAhdW2SCnFbtw228CHpP4MP8EGi5p_', null, false, true, 'Composr', array('content' => 'Arrowchat - A user just reported a conversation for spam/abuse: ' . $db->escape_string($report_about) . '. Please mark a thumbs up reaction to this message to indicate you will handle this report.'));
