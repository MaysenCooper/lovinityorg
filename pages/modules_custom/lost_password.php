...
class Module_lost_password
{
    ...
    public function step3()
    {
        ...
        if (!$temporary_passwords) {
            ...
            // EDIT: added website passphrase as param 7
            $message = do_lang($lang_string, comcode_escape($new_password), $login_url, array(comcode_escape(get_site_name()), comcode_escape($username), $account_edit_url->evaluate(), comcode_escape($email), get_value('website_passphrase')));
            require_code('mail');
