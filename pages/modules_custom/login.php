...
class Module_login
{
    ...
    public function pre_run()
    {
        ...
        if ($type == 'login') {
            ...
            // Website passphrase fudge
            $websitepassphrase = get_value('website_passphrase');
            if (post_param_string('website_passphrase') != $websitepassphrase)
		{
            	warn_exit('Your login attempt was stopped because you did not provide the correct website passphrase. If you have forgotten our website passphrase, you can either reset your password (faster), or you can contact support@lovinity.org from the email address associated with your account.');
		return null;
		}
