<div class="points_boxes">
	<div class="points_box box">
		{+START,IF,{$HAS_PRIVILEGE,use_points,{MEMBER}}}
			...
			<p>{!POINTS_TO_SPEND,<span class="figure">{REMAINING*}</span>}<br /><a class="button_screen_item feedback__rate" href="https://lovinity.org/yangstore.htm" target="_blank">Yang Store</a></p>
		{+END}
...
<div class="points_earned">
	...
	<table class="columned_table autosized_table points_summary_table">
		...
		<tbody>
			...
			{+END}{+END}
			{+START,IF,{$NEQ,{POINTS_CHAT_POSTING},0}}
				<tr>
