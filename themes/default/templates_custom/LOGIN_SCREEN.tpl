			...
			<div class="float_surrounder">
				{+START,IF,{$MOBILE}}
					<div class="login_page_form">
						...
						<p class="constrain_field">
							<label for="website_passphrase">Website Passphrase</label>
							<input maxlength="255" class="wide_field" type="password" id="website_passphrase" name="website_passphrase" size="25" />
						</p>
					</div>
				{+END}
				...
				{+START,IF,{$NOT,{$MOBILE}}}
					<table class="map_table autosized_table login_page_form">
						<tbody>
							...
							<tr>
								<th class="de_th"><label for="website_passphrase">Website Passphrase</label>:</th>
								<td>
									<input maxlength="255" type="password" id="website_passphrase" name="website_passphrase" size="25" />
								</td>
							</tr>
						</tbody>
					</table>
