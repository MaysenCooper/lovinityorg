...
{$,<script type="text/javascript" src="{$CDN_FILTER*,{$CUSTOM_BASE_URL}/arrowchat/includes/js/jquery.js}"></script>
<script type="text/javascript" src="{$CDN_FILTER*,{$CUSTOM_BASE_URL}/arrowchat/includes/js/jquery-ui.js}"></script>}
...
{+START,IF,{$IS_GUEST}}
smartlook('tag', 'name', 'Guest_{$SESSION}');
{+END}
{+START,IF,{$NOT,{$IS_GUEST}}}
smartlook('tag', 'email', '{$MEMBER_EMAIL}');
smartlook('tag', 'name', '{$USERNAME}_{$SESSION}');
smartlook('tag', 'userID', '{$MEMBER}');
{+END}
    smartlook('init', '4de2d01962d4dff521b988b66e3b0604443368cc');
</script>
</head>
	...
	<div id="main_website_inner">
		{+START,IF,{$SHOW_HEADER}}
			<header itemscope="itemscope" itemtype="http://schema.org/WPHeader" role="banner">
				...
				{$,The banner}
					{$SET-,BANNER,{$BANNER,{$?,{$MOBILE},topmobile,}}} {$,This is to avoid evaluating the banner twice}
				...
				<div class="global_navigation">
					{$BLOCK,block=menu,param=global2_menu,type={$?,{$MOBILE},mobile,dropdown}}
					...
					<div class="global_navigation_inner">
						...
						{+START,IF,{$NOT,{$IS_GUEST}}}{+START,IF,{$OR,{$CONFIG_OPTION,block_top_notifications},{$CONFIG_OPTION,block_top_personal_stats}}}
							<div class="top_buttons" id="cns_ads_notifications">
...
<div class="ZODbPXBaoJns" id="ZODbPXBaoJns">
					...
					{+START,IF_NON_EMPTY,{$GET,BANNER}}
					{$REQUIRE_JAVASCRIPT,ad}
					{$REQUIRE_JAVASCRIPT,ads}
		...
		{+START,IF,{$SHOW_FOOTER}}
{$SET,B72815,{$BANNER,728x15}} {$,This is to avoid evaluating the banner parameter twice}
{+START,IF_NON_EMPTY,{$GET,B72815}}
<div class="global_messages" id="bottom_ads">
{$GET,B72815}
</div>
{+END}
...
<script type="text/javascript" src="/arrowchat/external.php?type=djs&ad_number=0" charset="utf-8"></script>
<script type="text/javascript" src="/arrowchat/external.php?type=js&ad_number=0" charset="utf-8"></script>
		{+END}
