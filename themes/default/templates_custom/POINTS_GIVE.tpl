{+START,SET,roles}
	...
	<option value="Wise Mind">Wise Mind</option>
	<option value="Supportive Soul">Supportive Soul</option>
	<option value="Randomly Kind">Randomly Kind</option>
	<option value="Busy for Good">Busy for Good</option>
	...
	<form title="{!GIVE_POINTS}" method="post" onsubmit="return check_form(this);" action="{GIVE_URL*}#tab__points">
		...
		<div>
			...
			<div class="points_give_choices">
				...
				<p>
					<strong>Before awarding gift points:</strong> look at <a href="https://lovinity.org/leaders" target="_blank">Leaders</a> to see what each gift point role option is for. Choose the best role.
				</p>
			</div>
		</div>
	</form>
