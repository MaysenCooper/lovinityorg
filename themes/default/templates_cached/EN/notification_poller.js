...
{var go_func=function(){var sound_url='data/sounds/message_received.mp3';var base_url=((sound_url.indexOf('data_custom')==-1)&&(sound_url.indexOf('uploads/')==-1))?'':'https://www.lovinity.org';var sound_object=window.soundManager.createSound({url:base_url+'/'+sound_url});if(sound_object)sound_object.play();};if(!window.soundManager.setupOptions.url)
