...
toolbar.push(['composr_block','composr_comcode',precision_editing?'composr_page':null,'composr_quote',precision_editing?'composr_box':null,'composr_code']);var editor_settings={skin:'kama',enterMode:window.CKEDITOR.ENTER_BR,uiColor:wysiwyg_color,ocpTheme:'default',fontSize_sizes:'0.6em;0.85em;1em;1.1em;1.2em;1.3em;1.4em;1.5em;1.6em;1.7em;1.8em;2em',removePlugins:'',extraPlugins:'showcomcodeblocks,imagepaste,spellchecktoggle'+(use_composr_toolbar?',composr':''),customConfig:'',bodyId:'wysiwyg_editor',baseHref:get_base_url()+'/',linkShowAdvancedTab:true,imageShowAdvancedTab:true,imageShowLinkTab:true,imageShowSizing:true,autoUpdateElement:true,contentsCss:page_stylesheets,cssStatic:css,startupOutlineBlocks:true,language:(window.cms_lang)?cms_lang.toLowerCase():'en',emailProtection:false,resize_enabled:true,width:(find_width(element)-15),height:(window.location.href.indexOf('cms_comcode_pages')==-1)?250:500,toolbar:toolbar,allowedContent:true,browserContextMenuOnCtrl:true,comcodeXMLBlockTags:'overlay,section,big_tab,tabs,tab,carousel,media_set,staff_note,box,codebox,no_parse,code,hide,quote,moderator_message,moderator_closed,moderator_moved,moderator_featured,moderator_inactive_account,encrypt,pencrypt',comcodeXMLInlineTags:'tooltip,if_in_group,img,concept,ticker,pulse,require_css,require_javascript',magicline_everywhere:true,autoGrow_onStartup:true};if(typeof window.CKEDITOR.instances[element.id]!='undefined'&&window.CKEDITOR.instances[element.id])
