<span class="credits_bar">
	...
	{+START,IF,{$NOT,{$IS_GUEST}}}
		<span class="gb_credits_available">{CREDITS_MSG*}</span>{+START,IF,{$NOT,{$GET,show_whats_this}}}{NO_CREDITS_LINK*}{+END}{+START,IF,{$NEQ,{TICKETS_OPEN},0}}{TICKETS_OPEN_MSG}{+END}
	{+END}
