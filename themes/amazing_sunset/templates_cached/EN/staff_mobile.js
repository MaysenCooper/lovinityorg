...
contextual_css_edit();window.setTimeout(contextual_css_edit,2000);var url_patterns=[{pattern:/^https:\/\/www.lovinity.org\/banners\/view.htm\?source=([^&]*)/,hook:'banner'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-banners\/_edit\/([^&]*).htm/,hook:'banner'},{pattern:/^https:\/\/www.lovinity.org\/calendar\/browse\/([^&]*).htm/,hook:'calendar_type'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-calendar\/_edit_category\/([^&]*).htm/,hook:'calendar_type'},{pattern:/^https:\/\/www.lovinity.org\/catalogues\/category\/([^&]*).htm/,hook:'catalogue_category'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-catalogues\/_edit_category\/([^&]*).htm/,hook:'catalogue_category'},{pattern:/^https:\/\/www.lovinity.org\/catalogues\/entry\/([^&]*).htm/,hook:'catalogue_entry'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-catalogues\/_edit\/([^&]*).htm/,hook:'catalogue_entry'},{pattern:/^https:\/\/www.lovinity.org\/catalogues\/index\/([^&]*).htm/,hook:'catalogue'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-catalogues\/_edit_catalogue\/([^&]*).htm/,hook:'catalogue'},{pattern:/^https:\/\/www.lovinity.org\/([^&]*)\/?-WILD.htm/,hook:'comcode_page'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-comcode-pages\/_edit.htm\?page_link=([^&]*)/,hook:'comcode_page'},{pattern:/^https:\/\/www.lovinity.org\/downloads\/browse\/([^&]*).htm/,hook:'download_category'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-downloads\/_edit_category\/([^&]*).htm/,hook:'download_category'},{pattern:/^https:\/\/www.lovinity.org\/downloads\/entry\/([^&]*).htm/,hook:'download'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-downloads\/_edit\/([^&]*).htm/,hook:'download'},{pattern:/^https:\/\/www.lovinity.org\/calendar\/view\/([^&]*).htm/,hook:'event'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-calendar\/_edit\/([^&]*).htm/,hook:'event'},{pattern:/^https:\/\/www.lovinity.org\/forum\/forumview\/browse\/([^&]*).htm/,hook:'forum'},{pattern:/^https:\/\/www.lovinity.org\/adminzone\/admin-cns-forums\/_edit_category\/([^&]*).htm/,hook:'forum'},{pattern:/^https:\/\/www.lovinity.org\/galleries\/browse\/([^&]*).htm/,hook:'gallery'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-galleries\/_edit_category\/([^&]*).htm/,hook:'gallery'},{pattern:/^https:\/\/www.lovinity.org\/groups\/view\/([^&]*).htm/,hook:'group'},{pattern:/^https:\/\/www.lovinity.org\/adminzone\/admin-cns-groups\/_edit\/([^&]*).htm/,hook:'group'},{pattern:/^https:\/\/www.lovinity.org\/galleries\/image\/([^&]*).htm/,hook:'image'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-galleries\/_edit\/([^&]*).htm/,hook:'image'},{pattern:/^https:\/\/www.lovinity.org\/members\/view\/([^&]*).htm/,hook:'member'},{pattern:/^https:\/\/www.lovinity.org\/news\/browse\/([^&]*).htm/,hook:'news_category'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-news\/_edit_category\/([^&]*).htm/,hook:'news_category'},{pattern:/^https:\/\/www.lovinity.org\/news\/view\/([^&]*).htm/,hook:'news'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-news\/_edit\/([^&]*).htm/,hook:'news'},{pattern:/^https:\/\/www.lovinity.org\/polls\/view\/([^&]*).htm/,hook:'poll'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-polls\/_edit\/([^&]*).htm/,hook:'poll'},{pattern:/^https:\/\/www.lovinity.org\/forum\/topicview\/findpost\/([^&]*).htm/,hook:'post'},{pattern:/^https:\/\/www.lovinity.org\/forum\/topics\/edit_post\/([^&]*).htm/,hook:'post'},{pattern:/^https:\/\/www.lovinity.org\/quiz\/do\/([^&]*).htm/,hook:'quiz'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-quiz\/_edit\/([^&]*).htm/,hook:'quiz'},{pattern:/^https:\/\/www.lovinity.org\/forum\/topicview\/browse\/([^&]*).htm/,hook:'topic'},{pattern:/^https:\/\/www.lovinity.org\/forum\/topics\/edit_topic\/([^&]*).htm/,hook:'topic'},{pattern:/^https:\/\/www.lovinity.org\/galleries\/video\/([^&]*).htm/,hook:'video'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-galleries\/_edit_other\/([^&]*).htm/,hook:'video'},{pattern:/^https:\/\/www.lovinity.org\/s\/([^&]*).htm/,hook:'wiki_page'},{pattern:/^https:\/\/www.lovinity.org\/cms\/cms-wiki\/edit_page\/([^&]*).htm/,hook:'wiki_page'},{pattern:/^https:\/\/www.lovinity.org\/wiki\/find_post\/([^&]*).htm/,hook:'wiki_post'},{pattern:/^https:\/\/www.lovinity.org\/wiki\/post.htm\?post_id=([^&]*)/,hook:'wiki_post'},{pattern:/^https:\/\/www.lovinity.org\/tester\/report\/([^&]*).htm/,hook:'tester'},{pattern:/^https:\/\/www.lovinity.org\/tester\/_edit\/([^&]*).htm/,hook:'tester'}];var cells=document.getElementsByTagName('td');var links=[];if(window.location.href.replace('','').indexOf('/cms/')!=-1)
...
{if(typeof window.cms_theme=='undefined')window.cms_theme='amazing_sunset';if(typeof window.cms_lang=='undefined')window.cms_lang='EN';if((typeof win.document.querySelectorAll!='undefined')&&(typeof window.cms_lang!='undefined')&&(typeof window.cms_theme!='undefined'))
...
{sheet=win.document.styleSheets[i].href.substring(l+('/templates_cached/'+window.cms_lang+'/').length,win.document.styleSheets[i].href.length).replace('_non_minified','').replace('_ssl','').replace('_mobile','').replace(/\?\d+/,'').replace('.css','');possibilities.push(sheet);}}}
catch(e){}}
...
{cancel_bubbling(event);if(typeof event.preventDefault!='undefined')event.preventDefault();if(src.indexOf('/themes/')!=-1)
ob.edit_window=window.open('https://www.lovinity.org/adminzone/index.php?page=admin_themes&type=edit_image&lang='+window.encodeURIComponent(window.cms_lang)+'&theme='+window.encodeURIComponent(window.cms_theme)+'&url='+window.encodeURIComponent(src.replace('https://www.lovinity.org/',''))+keep_stub(),'edit_theme_image_'+ob.id);else window.fauxmodal_alert('The image you clicked is not a theme image, and thus must be edited by some alternative means.');return false;}
return true;}
...
{url+=window.encodeURIComponent('The Lovinity Community+'.replace(/[^a-zA-Z0-9\_\-\\\[\]{}\^`|]/g,''));}
...
{new Image().src='https://cdn1.lovinity.org/themes/default/images/checklist/cross2.png';new Image().src='https://cdn1.lovinity.org/themes/default/images/checklist/toggleicon2.png';var checklist_rows=get_elements_by_class_name(document,'checklist_row'),row_imgs,src;for(var i=0;i<checklist_rows.length;i++)
...
{load_snippet('checklist_task_manage','type=mark_done&id='+window.encodeURIComponent(id));ob.onclick=function(){mark_undone(ob,id);};ob.getElementsByTagName('img')[1].setAttribute('src','https://cdn1.lovinity.org/themes/amazing_sunset/images/checklist/checklist1.png');}
function mark_undone(ob,id)
{load_snippet('checklist_task_manage','type=mark_undone&id='+window.encodeURIComponent(id));ob.onclick=function(){mark_done(ob,id);};ob.getElementsByTagName('img')[1].setAttribute('src','https://cdn1.lovinity.org/themes/default/images/checklist/not_completed.png');}
