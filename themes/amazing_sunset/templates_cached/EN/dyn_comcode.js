...
{data.fp_animation=document.getElementById('image_fader_'+id);data.fp_animation_fader=document.createElement('img');data.tease_title=document.getElementById('image_fader_title_'+id);data.tease_scrolling_text=document.getElementById('image_fader_scrolling_text_'+id);data.fp_animation_fader.className='img_thumb';data.fp_animation.parentNode.insertBefore(data.fp_animation_fader,data.fp_animation);data.fp_animation.parentNode.style.position='relative';data.fp_animation.parentNode.style.display='block';data.fp_animation_fader.style.position='absolute';data.fp_animation_fader.src='https://cdn1.lovinity.org/themes/default/images/blank.gif'.replace(/^https?:/,window.location.protocol);}
...
{new Image().src='https://cdn1.lovinity.org/themes/amazing_sunset/images/big_tabs_controller_button.png'.replace(/^https?:/,window.location.protocol);new Image().src='https://cdn1.lovinity.org/themes/amazing_sunset/images/big_tabs_controller_button_active.png'.replace(/^https?:/,window.location.protocol);new Image().src='https://cdn1.lovinity.org/themes/amazing_sunset/images/big_tabs_controller_button_top_active.png'.replace(/^https?:/,window.location.protocol);new Image().src='https://cdn1.lovinity.org/themes/amazing_sunset/images/big_tabs_controller_button_top.png'.replace(/^https?:/,window.location.protocol);}
...
{var left=document.createElement('img');left.setAttribute('src','https://cdn1.lovinity.org/themes/default/images/carousel/fade_left.png');left.style.position='absolute';left.style.left='43px';left.style.top='0';main.parentNode.appendChild(left);var right=document.createElement('img');right.setAttribute('src','https://cdn1.lovinity.org/themes/default/images/carousel/fade_right.png');right.style.position='absolute';right.style.right='43px';right.style.top='0';main.parentNode.appendChild(right);}
