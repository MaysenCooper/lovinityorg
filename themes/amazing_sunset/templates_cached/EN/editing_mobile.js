...
{if(!authorised)
{var url='https://www.lovinity.org/data/upload_syndication_auth.php?hook='+window.encodeURIComponent(hook)+'&name='+window.encodeURIComponent(name)+keep_stub();window.open(url);if(!pre_disabled)
