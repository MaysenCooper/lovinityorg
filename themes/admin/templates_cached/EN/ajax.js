...
{if(typeof look_for=='undefined')look_for=[];if(typeof extra_params=='undefined')extra_params=[];if(typeof append=='undefined')append=false;if(typeof forms_too=='undefined')forms_too=false;if(typeof scroll_to_top=='undefined')scroll_to_top=true;var block_pos_y=find_pos_y(block_element,true);if(block_pos_y>get_window_scroll_y()){scroll_to_top=false;}
...
var loading_image=document.createElement('img');loading_image.className='ajax_loading_block';loading_image.src='https://cdn1.lovinity.org/themes/admin/images_custom/./ajax-loader.gif'.replace(/^https?:/,window.location.protocol);loading_image.style.position='absolute';loading_image.style.zIndex='1000';loading_image.style.left=(find_width(target_div)/2-10)+'px';if(!append)
