...
class Hook_snippet_checklist_task_manage
{
	...
	$postparam = array();
	$embedfields = array();
	$temp = comcode_to_tempcode($task_title);
        $_task_title = db_escape_string(trim(preg_replace('/\s+/', ' ', strip_html($temp->evaluate())))) . "\n";
	$embedfields[0] = array('name' => 'Task Added', 'value' => $_task_title);
	$embeds = array();
	$embeds[0] = array('title' => 'A staff task has been added', 'color' => '33023', 'fields' => $embedfields);
	...
	$temp = comcode_to_tempcode($task_title);
        $_task_title = db_escape_string(trim(preg_replace('/\s+/', ' ', strip_html($temp->evaluate())))) . "\n";
	$embedfields[0] = array('name' => 'Task Deleted', 'value' => $_task_title);
	$embeds = array();
	$embeds[0] = array('title' => 'A staff task has been deleted', 'color' => '33023', 'fields' => $embedfields);
	$postparam['embeds'] = $embeds;
	$postparam = json_encode($postparam);
	http_download_file('https://discordapp.com/api/webhooks/276127156701102083/AC3U7mWGK04oYIQ0sPITYD7QY60VAMWPMBUU_KxAhdW2SCnFbtw228CHpP4MP8EGi5p_', null, false, true, 'Composr', array($postparam), null, null, null, null, null, null, null, 6.0, true, null, null, null, 'application/json');
                }
	...
	$temp = comcode_to_tempcode($task_title);
        $_task_title = db_escape_string(trim(preg_replace('/\s+/', ' ', strip_html($temp->evaluate())))) . "\n";
	$embedfields[0] = array('name' => 'Task Completed', 'value' => $_task_title);
	$embeds = array();
	$embeds[0] = array('title' => 'A staff task has been marked as completed', 'color' => '33023', 'fields' => $embedfields);
	$postparam['embeds'] = $embeds;
	$postparam = json_encode($postparam);
	http_download_file('https://discordapp.com/api/webhooks/276127156701102083/AC3U7mWGK04oYIQ0sPITYD7QY60VAMWPMBUU_KxAhdW2SCnFbtw228CHpP4MP8EGi5p_', null, false, true, 'Composr', array($postparam), null, null, null, null, null, null, null, 6.0, true, null, null, null, 'application/json');
                }
	...
	$temp = comcode_to_tempcode($task_title);
        $_task_title = db_escape_string(trim(preg_replace('/\s+/', ' ', strip_html($temp->evaluate())))) . "\n";
	$embedfields[0] = array('name' => 'Task Not Completed', 'value' => $_task_title);
	$embeds = array();
	$embeds[0] = array('title' => 'A staff task has been marked not completed', 'color' => '33023', 'fields' => $embedfields);
	$postparam['embeds'] = $embeds;
	$postparam = json_encode($postparam);
	http_download_file('https://discordapp.com/api/webhooks/276127156701102083/AC3U7mWGK04oYIQ0sPITYD7QY60VAMWPMBUU_KxAhdW2SCnFbtw228CHpP4MP8EGi5p_', null, false, true, 'Composr', array($postparam), null, null, null, null, null, null, null, 6.0, true, null, null, null, 'application/json');
