...
END;
        ...
        if ((is_dir($dir)) && ((!isset($GLOBALS['SEMI_DEV_MODE'])) || (!$GLOBALS['SEMI_DEV_MODE']) || (!empty($_GET['keep_no_dev_mode'])))) {
        	...
        	if ($error != 'The requested banner does not exist. It has probably been deleted.')
        	{
                // Discord server push
	...
	$embeds = array();
	$embeds[0] = array('title' => 'A critical error has occurred', 'color' => '16744448', 'thumbnail' => $thumbfields, 'fields' => $embedfields);
