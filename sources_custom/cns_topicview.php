...
function cns_render_post_buttons($topic_info, $_postdetails, $may_reply, $rendering_context = 'cns')
{
    ...
    if ($rendering_context != 'tickets') {
        if ((array_key_exists('may_report_posts', $topic_info)) && (addon_installed('reported_content')) && (is_null(get_bot_type()))) {
            $action_url = build_url(array('page' => 'report_content', 'content_type' => 'post', 'content_id' => $_postdetails['id'], 'url' => get_self_url(true)), get_module_zone('reported_content'));
