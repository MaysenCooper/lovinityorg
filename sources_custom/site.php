...
function do_site()
{
    ...
    if ($securityscore > 74)
    {
    	attach_message(protect_from_escaping('Our systems have detected very suspicious activity within the last 24 hours and therefore are under a high security risk. Please report suspicious activity to support@lovinity.org and be mindful of your security here. If security gets worse, the website may temporarily shut down as a precaution.'), 'securitywarn');
    }
    else if ($securityscore > 49)
    {
    	attach_message(protect_from_escaping('Our systems have detected suspicious activity within the last 24 hours, and therefore are under an elevated security risk. Please report suspicious activity to support@lovinity.org and be mindful of your security here.'), 'securitynotice');
    }
