...
class CMS_Topic
{
     ...
     */
    public function render_as_comment_topic($content_type, $content_id, $allow_comments, $invisible_if_no_comments, $forum_name, $post_warning, $preloaded_comments, $explicit_allow, $reverse, $highlight_by_member, $allow_reviews, $num_to_show_limit, $hash_only = false)
    {
        ...
        if (!$this->error) {
            ...
            require_code('crypt');
            $out = do_template('COMMENTS_WRAPPER', array(
            ...
            $out = internalise_own_screen($out, 15, $this->total_posts, is_null($topic_id) ? '0' : $topic_id);
            return $out;
        }
